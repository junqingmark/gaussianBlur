...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("gauss1blur.vs", "gauss1blur.fs"); 
    ...
    FREE_IMAGE_FORMAT format = FreeImage_GetFileType("test.png", 0);
    FIBITMAP* dib = FreeImage_Load(format, "test.png", 0);
